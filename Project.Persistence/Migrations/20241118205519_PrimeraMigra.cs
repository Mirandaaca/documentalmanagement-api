        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnioGestion = table.Column<int>(type: "int", nullable: false),
                    FechaPrimerSemestreInicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaSegundoSemestreInicio = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaPrimerSemestreFin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    FechaSegundoSemestreFin = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CorreoInstitucion = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Bitacoras_AspNetUsers_IdUsuario",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    IdCategoriaDocumento = table.Column<int>(type: "int", nullable: false),
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Descripcion = table.Column<string>(type: "nvarchar(max)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TipoDocumentos_CategoriasDocumento_IdCategoriaDocumento",
                        column: x => x.IdCategoriaDocumento,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Nombre = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Apellido = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    NroRegistro = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    FechaNacimiento = table.Column<DateTime>(type: "datetime2", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Documentos_AspNetUsers_IdUsuario",
                        column: x => x.IdUsuario,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Documentos_Gestiones_IdGestion",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Documentos_IdEstudiante",
                table: "Documentos",
                column: "IdEstudiante");

            migrationBuilder.CreateIndex(
                name: "IX_Documentos_IdGestion",
                table: "Documentos",
                column: "IdGestion");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TipoDocumentos_IdCategoriaDocumento",
                table: "TipoDocumentos",
                column: "IdCategoriaDocumento");
        }
